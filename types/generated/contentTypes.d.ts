...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    p3: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 800;
      }>;
    p4: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 800;
      }>;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    ...
    productPrice: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Best Seller', 'On Sale', 'New Arrival', 'Top Rated']
    >;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiTopCategoryTopCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Sofa Set', 'Bed', 'Dressing Table', 'Bed Set', 'Dinning Table']
    >;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Price: Schema.Attribute.Integer;
    image2: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    image3: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    image4: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Price2: Schema.Attribute.Integer;
    Price3: Schema.Attribute.Integer;
    Price4: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
